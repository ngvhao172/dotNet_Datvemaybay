...
namespace Csharp_DatVeMayBay.Data
{
    public class DBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            User user = new User {UserId = 1, UserEmail = "ngvhao@gmail.com", FirstName = "Nguyễn Văn", LastName = "Hào", Address = "Huế, Việt Nam", Dob = new DateTime(2003, 12, 7), PhoneNumber = "0777777777" };
            Account acc = new Account { UserEmail = "ngvhao@gmail.com", Password = BCrypt.Net.BCrypt.EnhancedHashPassword("123",13), Enable = true , UserId = 1};
         /*   User user2 = new User {UserId = 2, UserEmail = "admin@gmail.com", FirstName = "Admin", LastName = "", Address = "", Dob = new DateTime(2003, 12, 7), PhoneNumber = "" };
            Account acc2 = new Account { UserEmail = "admin@gmail.com", Password = BCrypt.Net.BCrypt.EnhancedHashPassword("admin", 13), Enable = true, UserId = 2 };*/
        ...
        public (List<Flight>, List<Seat>) GenerateSampleFlights(int count)
        {
            ...
            for (int i = 1; i <= count; i++)
            {
                ...
                {
                    FlightId = i,
                    AirlineId = airlineIds[random.Next(0, airlineIds.Count)], // Chọn một số ngẫu nhiên từ 1 đến 5 cho airline_id
                    DepartureAiportId = 1, // Sử dụng airport_id của sân bay đi cố định
                    ArrivalAiportId = 2, // Sử dụng airport_id của sân bay đến cố định
